...
def run_cmd(command, verbose=False, debug=False, return_output=False, show_only=None):
    ...
    for line in proc.stdout:
        ...
        output += line
        if verbose or (show_only is not None and show_only in line):
            line = line.replace(show_only, '')
